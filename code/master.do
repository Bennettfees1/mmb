...
*	  4. ssc install the following packages
*			- fs
*			- moremata
*			- robreg
*			- coefplot
*			- texresults
*				^ Replace the texresults.ado with the altered version found in 
*					the misc folder of the replication folder. This ado edited 
*					by Margaret Jacobson allows us to input strings with 
*					texresults, which we use to make SEs in parentheses and 
*					significance stars in our tables. 
*
*************************SUPER DUPER IMPORTANT*************************
*		AFTER RUNNING THIS SCRIPT RUN MMB_robreg.ipynb manually!!!!
*			-	If anyone figures our how to smoothly call an .ipynb from a 
*				Stata .do file, email cmbrennan@uchicago.edu and I will Venmo 
*				you $20 (inflation adjusted from 2025)
***********************************************************************
********************************************************************************
clear all
macro drop _all
...
* 9/11 update
* ----------------------------
* Nominal rigidities variables
* ----------------------------
glo indepvars_nomrig_all = "stky_pr stky_wg pr_ndx wg_ndx i.stky_pr#i.pr_ndx i.stky_wg#i.wg_ndx i.stky_pr#i.not_pr_ndx i.stky_wg#i.not_wg_ndx i.stky_pr#i.wg_ndx i.stky_wg#i.pr_ndx i.stky_pr#i.not_wg_ndx i.stky_wg#i.not_pr_ndx"

* ----------------------------
* Real rigidities variables
* ----------------------------
glo indepvars_realrig_all = "wlth ntwrth bnkcrdit open learning i.wlth#i.ntwrth i.wlth#i.bnkcrdit i.wlth#i.open i.wlth#i.learning i.ntwrth#i.bnkcrdit i.ntwrth#i.open i.ntwrth#i.learning i.bnkcrdit#i.open i.bnkcrdit#i.learning i.open#i.learning"

* ----------------------------
* Non-model attributes variables
* ----------------------------
glo indepvars_nonmod_all = "cb_authors_ext ln_neq vint_early vint_mid vint_late est_early est_late i.cb_authors_ext#i.ln_neq i.cb_authors_ext#i.vint_early i.cb_authors_ext#i.vint_mid i.cb_authors_ext#i.vint_late i.cb_authors_ext#i.est_early i.cb_authors_ext#i.est_late i.ln_neq#i.vint_early i.ln_neq#i.vint_mid i.ln_neq#i.vint_late i.ln_neq#i.est_early i.ln_neq#i.est_late i.vint_early#i.est_early i.vint_early#i.est_late i.vint_mid#i.est_early i.vint_mid#i.est_late i.vint_late#i.est_early i.vint_late#i.est_late"

	* ----------------------------
	* All variables combined
	* ----------------------------
	glo indepvars_all_all = "${indepvars_nomrig_all} ${indepvars_realrig_all} ${indepvars_nonmod_all}"

	* ----------------------------
	* Subsets for specific tables
	* ----------------------------

	* Table 7 subset (nominal rigidities)
glo indepvars_nomrig   = "i.stky_wg#i.wg_ndx i.stky_wg#i.not_wg_ndx pr_ndx"

	* Table 8 subset (real rigidities)
	glo indepvars_realrig = "wlth bnkcrdit ntwrth open i.wlth#i.bnkcrdit i.ntwrth#i.bnkcrdit i.wlth#i.ntwrth i.wlth#i.open"

	* Table 10 subset (non-model attributes)
	glo indepvars_nonmod = "cb_authors_ext ln_neq vint_early vint_mid est_early"


	* All table-specific variables combined
	glo indepvars_all = "${indepvars_nomrig} ${indepvars_realrig} ${indepvars_nonmod}"
